...
POSE_HIGH_RESOLUTION_NET.STAGE2.NUM_BLOCKS = [1, 1]
POSE_HIGH_RESOLUTION_NET.STAGE2.NUM_LAYERS = [4, 4]
...
POSE_HIGH_RESOLUTION_NET.STAGE3.NUM_BLOCKS = [1, 1, 1]
POSE_HIGH_RESOLUTION_NET.STAGE3.NUM_LAYERS = [4, 4, 4]
...
POSE_HIGH_RESOLUTION_NET.STAGE4.NUM_BLOCKS = [1, 1, 1, 1]
POSE_HIGH_RESOLUTION_NET.STAGE4.NUM_LAYERS = [4, 4, 4, 4]
